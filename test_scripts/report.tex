...
\begin{figure}[H]
    ...
    \IfFileExists{fig_detections_scenario1.jpg}{%
        \includegraphics[width=0.9\linewidth]{fig_detections_scenario1.jpg}%
    }{%
...
\begin{figure}[H]
    ...
    \IfFileExists{fig_detections_scenario2.jpg}{%
        \includegraphics[width=0.9\linewidth]{fig_detections_scenario2.jpg}%
    }{%
...
\begin{figure}[H]
    ...
    \IfFileExists{fig_detections_scenario3.jpg}{%
        \includegraphics[width=0.9\linewidth]{fig_detections_scenario3.jpg}%
    }{%
...
\texttt{- CELL\_PHONE (object): from 3.0s to 19.5s (duration 16.5s)}\\
...
gain low, so noise is limited. Faces are detected with high confidence
