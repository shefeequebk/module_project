...
\newcommand{\StudentID}{YOUR UL ID HERE}
\newcommand{\RevisionTime}{DD/MM/YYYY HH:MM}

\begin{document}

% ---------- Title page ----------
\begin{titlepage}
    \thispagestyle{plain}  % No header/footer on title page
    ...
    \vspace{2cm}
    {\large
        \textbf{Student Name:} \textbf{\StudentName}\\[0.3cm]
        \textbf{Student ID:} \textbf{\StudentID}\\[0.3cm]
        Revision Timestamp: \RevisionTime
    }
    \vfill
\end{titlepage}
