...
\begin{figure}[H]
    ...
    \caption{Raspberry Pi~4 and camera setup for the experiment.\label{fig:setup}}
\end{figure}
...
\begin{figure}[H]
    \centering
    % Replace filename with your generated plot for Scenario 1, e.g. fig_detections_scenario1.jpg
    \IfFileExists{fig_detections_scenario1.jpg}{%
        \includegraphics[width=0.7\linewidth]{fig_detections_scenario1.jpg}%
    }{%
    ...
    \caption{Confidence over time for different people and objects in Scenario~1: Bright indoor room.\label{fig:timeline1}}
\end{figure}

\begin{figure}[H]
    \centering
    % Replace filename with your generated plot for Scenario 2, e.g. fig_detections_scenario2.jpg
    \IfFileExists{fig_detections_scenario2.jpg}{%
        \includegraphics[width=0.7\linewidth]{fig_detections_scenario2.jpg}%
    }{%
    ...
    \caption{Confidence over time for different people and objects in Scenario~2: Outdoor overcast daytime.\label{fig:timeline2}}
\end{figure}

\begin{figure}[H]
    \centering
    % Replace filename with your generated plot for Scenario 3, e.g. fig_detections_scenario3.jpg
    \IfFileExists{fig_detections_scenario3.jpg}{%
        \includegraphics[width=0.7\linewidth]{fig_detections_scenario3.jpg}%
    }{%
    ...
    \caption{Confidence over time for different people and objects in Scenario~3: Indoor low light with strong backlighting.\label{fig:timeline3}}
\end{figure}
...
\newblock Available at: \url{https://www.okdo.com/}.
Accessed: 2025.
